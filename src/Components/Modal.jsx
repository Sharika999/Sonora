        ...
        <>
            <div className="  text-center rounded-lg text-white font-bold">
                <button
                    type="button"
                    onClick={openModal}
                    className="w-full px-8 py-3 rounded-xl text-base tracking-wider font-medium border border-current outline-none bg-blue-600 hover:bg-transparent text-white hover:text-blue-600 transition-all duration-300"
                >
                    Proceed To Payment
                </button>
            </div>
                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <button onClick={() => { buyNow(); closeModal() }} type="button" className="focus:outline-none w-full text-white outline-0 font-medium rounded-lg text-sm px-5 py-2.5 tracking-wider  border border-current outline-none bg-blue-600 hover:bg-transparent hover:text-blue-600 transition-all duration-300">Order Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
